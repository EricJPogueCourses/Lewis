...
science including topics including computer architecture, networking, data organization, and security. Together we 
will explore algorithms, abstractions, computational problem solving and programming. </p>

<p>You have likely noticed that I am using the term “sprint 1” to describe our first set of course activities and
assignments. Sprints are part of the Scrum software development process. The term is used to describe a unit of work which will
...
<ul style={{listStyleType: "square"}}>
	...
	<li>Identify, define, and discuss various data representations</li>
	<li>Execute basic Python applications utilizing Python command line tools</li>
...
<ol>
	...
	<li>Complete “[[Todo: First topic”
		...
		[slides]</a></li>
	<li><em>Consistently work on Lab 1 and Quiz 1 throughout the sprint ~6 hours</em></li>
