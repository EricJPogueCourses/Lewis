...
<br />
<h4>Tools of the Trade Tutorial</h4>
<h5>Summary: Install, verify, and utilize important software development tools</h5>
<h5>Prerequisites: Windows 10 or MacOS</h5>

<p>To be a successful successful software developer (and to be successful in this course) you will need to effectively 
utilize many tools and services. In this tutorial we will install, verify, and utilize numerous tools and services. 
...
<ol>
	...
	<li>Install Visual Studio Code source code editor
		<a href='https://code.visualstudio.com/' target='_blank' rel='noopener noreferrer'>[link]</a>
		<a href='https://mediaatoz.blob.core.windows.net/environment-configuration/mscode-and-chrome-windows10-setup.mp4'>[tutorial]</a></li>
...
<ol>
	<li>Install the Git command line client
		<a href='https://git-scm.com/'>[link]</a><a href='https://mediaatoz.blob.core.windows.net/environment-configuration/git-installation-on-windows-10.mp4'>[tutorial]</a></li>
