...
class SESprint07 extends React.Component {
	render() {
		return (
...
<div>
	...
	<p>Welcome to sprint 7. This sprint will see us focussing more on our final project while we also take a look
	...
	<ol>
		<li><em>Review our sprint 7 assignments in Blackboard that include discussion board 7, quiz 7, lab 7, and
			reflections 7</em></li>
		<li>Continue working on your final project project and implement and test additional high priority functionality that you 
			identified last sprint</li>
