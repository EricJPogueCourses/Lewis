...
class SESprint03 extends React.Component {
	render() {
		return (
...
<div>
	...
	prescriptive. I also want to encourage you to collaborate more with your peers as you work through some of the open-ended topics.</p>
